-- Create database 'Challenge 6'
CREATE DATABASE challenge_6;

-- Make database as default
USE challenge_6;

-- Create the table 'sustainable_clothing'
...
-- Insert data into the table 'sustainable_clothing'
...
-- Create the table 'marketing_campaigns'
...
-- Insert data into the table 'marketing_campaigns'
